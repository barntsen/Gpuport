...
l1=pl.plot(x1,y1,label='Eps gh200',color='black',marker='o',linestyle='solid')
l2=pl.plot(x2,y2,label='Eps a100',color='red',marker='o',linestyle='solid')
...
pl.savefig('solvertime-eps-gh200-a100.pdf',bbox_inches='tight')
#pl.show()
