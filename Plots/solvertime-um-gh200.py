...
l1=pl.plot(x1,y1,label='Cuda ',color='black',marker='o',linestyle='solid')
l2=pl.plot(x2,y2,label='Cuda um',color='red',marker='o',linestyle='solid')
...
pl.savefig('solvertime-um-gh200.pdf',bbox_inches='tight')
#pl.show()
